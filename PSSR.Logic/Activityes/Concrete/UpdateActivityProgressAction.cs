...
{
    public class UpdateActivityProgressAction : BskaActionStatus, IUpdateActivityProgressAction
    {
        ...
        public UpdateActivityProgressAction(IUpdateActivityDbAccess acDbAcces, IUpdatePunchTypeDbAccess punchTypeDb
