   ...
   this.Draw = function()
   {
      ...
      if(vTaskList.length > 0)
      {
         ...
         if(vShowComp!=1) vNameWidth+=vStatusWidth;
          ...
          if (vShowRes == 1) vLeftTable += '  <TD style="background-color:#ef9608;WIDTH: ' + vStatusWidth + 'px; HEIGHT: 17px"></TD>' ;
          if (vShowDur == 1) vLeftTable += '  <TD style="background-color:#ef9608;WIDTH: ' + vStatusWidth + 'px; HEIGHT: 17px"></TD>' ;
          if (vShowComp == 1) vLeftTable += '  <TD style="background-color:#ef9608;WIDTH: ' + vStatusWidth + 'px; HEIGHT: 17px"></TD>' ;
          if (vShowStartDate == 1) vLeftTable += '  <TD style="background-color:#ef9608;WIDTH: ' + vStatusWidth + 'px; HEIGHT: 17px"></TD>' ;
          if (vShowEndDate == 1) vLeftTable += '  <TD style="background-color:#ef9608;WIDTH: ' + vStatusWidth + 'px; HEIGHT: 17px"></TD>' ;
